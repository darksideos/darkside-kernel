...
8000220b:	fb                   	sti    
8000220c:	c7 04 24 1c 73 00 80 	movl   $0x8000731c,(%esp)
80002213:	e8 b4 25 00 00       	call   800047cc <log>
80002218:	c7 04 24 2f 73 00 80 	movl   $0x8000732f,(%esp)
8000221f:	e8 a8 25 00 00       	call   800047cc <log>
80002224:	8b 44 24 20          	mov    0x20(%esp),%eax
80002228:	8b 40 08             	mov    0x8(%eax),%eax
8000222b:	05 00 04 00 00       	add    $0x400,%eax
80002230:	c1 e0 0a             	shl    $0xa,%eax
80002233:	89 04 24             	mov    %eax,(%esp)
80002236:	e8 59 05 00 00       	call   80002794 <init_pmm>
8000223b:	c7 04 24 44 73 00 80 	movl   $0x80007344,(%esp)
80002242:	e8 85 25 00 00       	call   800047cc <log>
80002247:	e8 cf 09 00 00       	call   80002c1b <init_vmm>
8000224c:	83 c4 1c             	add    $0x1c,%esp
8000224f:	c3                   	ret    
...
80004a2b:	c7 04 24 5c 87 00 80 	movl   $0x8000875c,(%esp)
...
800051e7:	c7 04 24 a4 87 00 80 	movl   $0x800087a4,(%esp)
...
800051f8:	c7 04 24 b4 87 00 80 	movl   $0x800087b4,(%esp)
...
80005209:	c7 04 24 c4 87 00 80 	movl   $0x800087c4,(%esp)
...
8000521a:	c7 04 24 d2 87 00 80 	movl   $0x800087d2,(%esp)
...
800052d8:	80 
800052d9:	c7 04 24 e2 87 00 80 	movl   $0x800087e2,(%esp)
...
80005305:	80 
80005306:	c7 04 24 f1 87 00 80 	movl   $0x800087f1,(%esp)
...
80005332:	80 
80005333:	c7 04 24 fe 87 00 80 	movl   $0x800087fe,(%esp)
...
8000535f:	80 
80005360:	c7 04 24 0d 88 00 80 	movl   $0x8000880d,(%esp)
...
80005917:	c7 44 24 04 1c 88 00 	movl   $0x8000881c,0x4(%esp)
8000591e:	80 
...
800059fd:	c7 44 24 04 1c 88 00 	movl   $0x8000881c,0x4(%esp)
80005a04:	80 
...
80005a5e:	c7 44 24 04 1c 88 00 	movl   $0x8000881c,0x4(%esp)
80005a65:	80 
...
80005a8e:	c7 44 24 04 1c 88 00 	movl   $0x8000881c,0x4(%esp)
80005a95:	80 
...
80005c82:	c7 00 1e 88 00 80    	movl   $0x8000881e,(%eax)
...
80005cce:	c7 00 24 88 00 80    	movl   $0x80008824,(%eax)
...
80005d1a:	c7 00 2b 88 00 80    	movl   $0x8000882b,(%eax)
...
8000635a:	ff 24 95 34 88 00 80 	jmp    *-0x7fff77cc(,%edx,4)
...
8000874e:	00 80 5b 20 25 30    	add    %al,0x3025205b(%eax)
80008754:	2e 32 66 20          	xor    %cs:0x20(%esi),%ah
80008758:	5d                   	pop    %ebp
80008759:	20 00                	and    %al,(%eax)
8000875b:	00 4d 61             	add    %cl,0x61(%ebp)
8000875e:	78 69                	js     800087c9 <rodata+0x17c9>
80008760:	6d                   	insl   (%dx),%es:(%edi)
80008761:	75 6d                	jne    800087d0 <rodata+0x17d0>
80008763:	20 6e 75             	and    %ch,0x75(%esi)
80008766:	6d                   	insl   (%dx),%es:(%edi)
80008767:	62 65 72             	bound  %esp,0x72(%ebp)
8000876a:	20 6f 66             	and    %ch,0x66(%edi)
8000876d:	20 70 72             	and    %dh,0x72(%eax)
80008770:	6f                   	outsl  %ds:(%esi),(%dx)
80008771:	63 65 73             	arpl   %sp,0x73(%ebp)
80008774:	73 65                	jae    800087db <rodata+0x17db>
80008776:	73 20                	jae    80008798 <rodata+0x1798>
80008778:	65                   	gs
80008779:	78 63                	js     800087de <rodata+0x17de>
8000877b:	65 65 64 65 64 2e 20 	gs gs fs gs fs and %dl,%cs:%fs:%gs:0x65(%eax,%ebp,2)
80008782:	54 68 65 
80008785:	20 70 72             	and    %dh,0x72(%eax)
80008788:	6f                   	outsl  %ds:(%esi),(%dx)
80008789:	63 65 73             	arpl   %sp,0x73(%ebp)
8000878c:	73 20                	jae    800087ae <rodata+0x17ae>
8000878e:	63 61 6e             	arpl   %sp,0x6e(%ecx)
80008791:	6e                   	outsb  %ds:(%esi),(%dx)
80008792:	6f                   	outsl  %ds:(%esi),(%dx)
80008793:	74 20                	je     800087b5 <rodata+0x17b5>
80008795:	62 65 20             	bound  %esp,0x20(%ebp)
80008798:	63 72 65             	arpl   %si,0x65(%edx)
8000879b:	61                   	popa   
8000879c:	74 65                	je     80008803 <rodata+0x1803>
8000879e:	64 2e 0a 00          	fs or  %cs:%fs:(%eax),%al
800087a2:	00 00                	add    %al,(%eax)
800087a4:	54                   	push   %esp
800087a5:	65                   	gs
800087a6:	73 74                	jae    8000881c <rodata+0x181c>
800087a8:	20 50 72             	and    %dl,0x72(%eax)
800087ab:	6f                   	outsl  %ds:(%esi),(%dx)
800087ac:	63 65 73             	arpl   %sp,0x73(%ebp)
800087af:	73 20                	jae    800087d1 <rodata+0x17d1>
800087b1:	33 0a                	xor    (%edx),%ecx
800087b3:	00 54 65 73          	add    %dl,0x73(%ebp,%eiz,2)
800087b7:	74 20                	je     800087d9 <rodata+0x17d9>
800087b9:	50                   	push   %eax
800087ba:	72 6f                	jb     8000882b <rodata+0x182b>
800087bc:	63 65 73             	arpl   %sp,0x73(%ebp)
800087bf:	73 20                	jae    800087e1 <rodata+0x17e1>
800087c1:	32 0a                	xor    (%edx),%cl
800087c3:	00 54 65 73          	add    %dl,0x73(%ebp,%eiz,2)
800087c7:	74 20                	je     800087e9 <rodata+0x17e9>
800087c9:	50                   	push   %eax
800087ca:	72 6f                	jb     8000883b <rodata+0x183b>
800087cc:	63 65 73             	arpl   %sp,0x73(%ebp)
800087cf:	73 0a                	jae    800087db <rodata+0x17db>
800087d1:	00 4b 65             	add    %cl,0x65(%ebx)
800087d4:	72 6e                	jb     80008844 <rodata+0x1844>
800087d6:	65                   	gs
800087d7:	6c                   	insb   (%dx),%es:(%edi)
800087d8:	20 50 72             	and    %dl,0x72(%eax)
800087db:	6f                   	outsl  %ds:(%esi),(%dx)
800087dc:	63 65 73             	arpl   %sp,0x73(%ebp)
800087df:	73 0a                	jae    800087eb <rodata+0x17eb>
800087e1:	00 4b 65             	add    %cl,0x65(%ebx)
800087e4:	72 6e                	jb     80008854 <rodata+0x1854>
800087e6:	65                   	gs
800087e7:	6c                   	insb   (%dx),%es:(%edi)
800087e8:	20 50 72             	and    %dl,0x72(%eax)
800087eb:	6f                   	outsl  %ds:(%esi),(%dx)
800087ec:	63 65 73             	arpl   %sp,0x73(%ebp)
800087ef:	73 00                	jae    800087f1 <rodata+0x17f1>
800087f1:	54                   	push   %esp
800087f2:	65                   	gs
800087f3:	73 74                	jae    80008869 <rodata+0x1869>
800087f5:	20 50 72             	and    %dl,0x72(%eax)
800087f8:	6f                   	outsl  %ds:(%esi),(%dx)
800087f9:	63 65 73             	arpl   %sp,0x73(%ebp)
800087fc:	73 00                	jae    800087fe <rodata+0x17fe>
800087fe:	54                   	push   %esp
800087ff:	65                   	gs
80008800:	73 74                	jae    80008876 <rodata+0x1876>
80008802:	20 50 72             	and    %dl,0x72(%eax)
80008805:	6f                   	outsl  %ds:(%esi),(%dx)
80008806:	63 65 73             	arpl   %sp,0x73(%ebp)
80008809:	73 20                	jae    8000882b <rodata+0x182b>
8000880b:	32 00                	xor    (%eax),%al
...
8000881a:	33 00                	xor    (%eax),%eax
8000881c:	2f                   	das    
8000881d:	00 73 74             	add    %dh,0x74(%ebx)
80008820:	64 69 6e 00 73 74 64 	imul   $0x6f647473,%fs:0x0(%esi),%ebp
80008827:	6f 
80008828:	75 74                	jne    8000889e <rodata+0x189e>
8000882a:	00 73 74             	add    %dh,0x74(%ebx)
8000882d:	64                   	fs
8000882e:	65                   	gs
8000882f:	72 72                	jb     800088a3 <rodata+0x18a3>
80008831:	00 00                	add    %al,(%eax)
80008833:	00 aa 63 00 80 c2    	add    %ch,-0x3d7fff9d(%edx)
80008839:	63 00                	arpl   %ax,(%eax)
8000883b:	80 c2 63             	add    $0x63,%dl
8000883e:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
80008844:	c2 63 00             	ret    $0x63
80008847:	80 c2 63             	add    $0x63,%dl
8000884a:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
80008850:	c2 63 00             	ret    $0x63
80008853:	80 c2 63             	add    $0x63,%dl
80008856:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
8000885c:	c2 63 00             	ret    $0x63
8000885f:	80 c2 63             	add    $0x63,%dl
80008862:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
80008868:	61                   	popa   
80008869:	63 00                	arpl   %ax,(%eax)
8000886b:	80 c2 63             	add    $0x63,%dl
8000886e:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
80008874:	c2 63 00             	ret    $0x63
80008877:	80 c2 63             	add    $0x63,%dl
8000887a:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
80008880:	c2 63 00             	ret    $0x63
80008883:	80 c2 63             	add    $0x63,%dl
80008886:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
8000888c:	c2 63 00             	ret    $0x63
8000888f:	80 c2 63             	add    $0x63,%dl
80008892:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
80008898:	70 63                	jo     800088fd <rodata+0x18fd>
8000889a:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
800088a0:	b6 63                	mov    $0x63,%dh
800088a2:	00 80 c2 63 00 80    	add    %al,-0x7fff9c3e(%eax)
800088a8:	7f 63                	jg     8000890d <rodata+0x190d>
800088aa:	00                   	.byte 0x0
800088ab:	80                   	.byte 0x80
